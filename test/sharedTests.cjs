...
module.exports = function(langs, assert) {
  describe('langs:', function () {
    ...
    before(function () {
      eng = { name:'English', local:'English', 1:'en', 2:'eng', '2T':'eng', '2B':'eng', 3:'eng', invertedName: 'English', refName: 'English', scope: 'I', type: 'L' };
      kor = { name:'Korean', local:'한국어', 1:'ko', 2:'kor', '2T':'kor', '2B':'kor', 3:'kor', invertedName: 'Korean', refName: 'Korean', scope: 'I', type: 'L' };
    });
    ...
    context('all:', function () {
      ...
      it("`langs.all()` contains `{ name: 'English', local: 'English', 1: 'en', 2: 'eng', 2T: 'eng', 2B: 'eng', 3: 'eng', invertedName: 'English', refName: 'English', scope: 'I', type: 'L' }`", function () {
        assert.deepInclude(langs.all(), eng);
      });

      it("`langs.all()` contains `{ name: 'Korean', local: '한국어', 1: 'ko', 2: 'kor', 2T: 'kor', 2B: 'kor', 3: 'kor', invertedName: 'Korean', refName: 'Korean', scope: 'I', type: 'L' }`", function () {
    ...
    context('where:', function () {
      ...
      it("`langs.where('name', 'English')` is `{ name: 'English', local: 'English', 1: 'en', 2: 'eng', 2T: 'eng', 2B: 'eng', 3: 'eng', invertedName: 'English', refName: 'English', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('name', 'English'), eng);
      });

      it("`langs.where('local', 'English')` is `{ name: 'English', local: 'English', 1: 'en', 2: 'eng', 2T: 'eng', 2B: 'eng', 3: 'eng', invertedName: 'English', refName: 'English', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('local', 'English'), eng);
      });

      it("`langs.where('1', 'en')` is `{ name: 'English', local: 'English', 1: 'en', 2: 'eng', 2T: 'eng', 2B: 'eng', 3: 'eng', invertedName: 'English', refName: 'English', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('1', 'en'), eng);
      });

      it("`langs.where('2', 'eng')` is `{ name: 'English', local: 'English', 1: 'en', 2: 'eng', 2T: 'eng', 2B: 'eng', 3: 'eng', invertedName: 'English', refName: 'English', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('2', 'eng'), eng);
      });

      it("`langs.where('2T', 'eng')` is `{ name: 'English', local: 'English', 1: 'en', 2: 'eng', 2T: 'eng', 2B: 'eng', 3: 'eng', invertedName: 'English', refName: 'English', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('2T', 'eng'), eng);
      });

      it("`langs.where('2B', 'eng')` is `{ name: 'English', local: 'English', 1: 'en', 2: 'eng', 2T: 'eng', 2B: 'eng', 3: 'eng', invertedName: 'English', refName: 'English', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('2B', 'eng'), eng);
      });

      it("`langs.where('3', 'eng')` is `{ name: 'English', local: 'English', 1: 'en', 2: 'eng', 2T: 'eng', 2B: 'eng', 3: 'eng', invertedName: 'English', refName: 'English', scope: 'I', type: 'L' }`", function () {
      ...
      it("`langs.where('name', 'Korean')` is `{ name: 'Korean', local: '한국어', 1: 'ko', 2: 'kor', 2T: 'kor', 2B: 'kor', 3: 'kor', invertedName: 'Korean', refName: 'Korean', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('name', 'Korean'), kor);
      });

      it("`langs.where('local', '한국어')` is `{ name: 'Korean', local: '한국어', 1: 'ko', 2: 'kor', 2T: 'kor', 2B: 'kor', 3: 'kor', invertedName: 'Korean', refName: 'Korean', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('local', '한국어'), kor);
      });

      it("`langs.where('1', 'ko')` is `{ name: 'Korean', local: '한국어', 1: 'ko', 2: 'kor', 2T: 'kor', 2B: 'kor', 3: 'kor', invertedName: 'Korean', refName: 'Korean', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('1', 'ko'), kor);
      });

      it("`langs.where('2', 'kor')` is `{ name: 'Korean', local: '한국어', 1: 'ko', 2: 'kor', 2T: 'kor', 2B: 'kor', 3: 'kor', invertedName: 'Korean', refName: 'Korean', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('2', 'kor'), kor);
      });

      it("`langs.where('2T', 'kor')` is `{ name: 'Korean', local: '한국어', 1: 'ko', 2: 'kor', 2T: 'kor', 2B: 'kor', 3: 'kor', invertedName: 'Korean', refName: 'Korean', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('2T', 'kor'), kor);
      });

      it("`langs.where('2B', 'kor')` is `{ name: 'Korean', local: '한국어', 1: 'ko', 2: 'kor', 2T: 'kor', 2B: 'kor', 3: 'kor', invertedName: 'Korean', refName: 'Korean', scope: 'I', type: 'L' }`", function () {
        assert.deepEqual(langs.where('2B', 'kor'), kor);
      });

      it("`langs.where('3', 'kor')` is `{ name: 'Korean', local: '한국어', 1: 'ko', 2: 'kor', 2T: 'kor', 2B: 'kor', 3: 'kor', invertedName: 'Korean', refName: 'Korean', scope: 'I', type: 'L' }`", function () {
